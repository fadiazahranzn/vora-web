...
describe('MoodCheckinModal', () => {
    ...
    it('should handle Positive Path (Happy)', async () => {
        ...
        // mascot cheers immediately (sync)
        expect(screen.getByTestId('mascot')).toHaveAttribute('data-expression', 'cheering')
    ...
    it('should handle Negative Path (Sad) -> Reflection -> Activities -> Support', async () => {
        ...
        expect(screen.getByTestId('mascot')).toHaveAttribute('data-expression', 'concerned')
        ...
        expect(screen.getByPlaceholderText("What's making you feel this way?")).toBeInTheDocument()

        // 3. Reflection -> Activities
        const reflectionText = "Missed goal"
        fireEvent.change(screen.getByPlaceholderText("What's making you feel this way?"), { target: { value: reflectionText } })
        fireEvent.click(screen.getByText('Continue'))

        expect(screen.getByText('What would help?')).toBeInTheDocument()
        expect(screen.getByTestId('mascot')).toHaveAttribute('data-expression', 'neutral')
        ...
        expect(screen.getByTestId('mascot')).toHaveAttribute('data-expression', 'supportive')
    ...
    it('should enforce character limit on reflection', async () => {
        ...
        const textarea = screen.getByPlaceholderText("What's making you feel this way?")
