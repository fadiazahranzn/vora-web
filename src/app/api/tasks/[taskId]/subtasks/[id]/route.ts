...
export async function PATCH(
    ...
    try {
        ...
        const isCompletingSubTask = validatedData.completedAt !== undefined && validatedData.completedAt !== null && !existingSubTask.completedAt;
        const isUncompletingSubTask = validatedData.completedAt === null && !!existingSubTask.completedAt;
