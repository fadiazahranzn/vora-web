...
const ActivityChartImpl: React.FC<ActivityChartImplProps> = ({ data, view }) => {
    ...
    return (
        <ResponsiveContainer width="100%" height="100%">
            ...
            >
                <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="var(--vora-color-border)" />
                <XAxis
                    dataKey="date"
                ...
                <Line
                    ...
                    dot={{ r: 4, fill: 'var(--vora-color-primary)', strokeWidth: 2, stroke: 'var(--vora-color-bg-surface)' }}
